...
describe('src/action/actionTypes.js', () => {
  context('searchBookSuccess', () => {
  ...
  context('fetchReadingListSuccess', () => {
    it('Should return the action', () => {
      const books = 'books';
